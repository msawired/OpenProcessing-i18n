OP.languageLibraryDefault = {
	...
	"sketch": {
		...
		"forkInfo": {
			...
			"zh": "由{username}製作的{sketchtitle}的Fork"
		},
		"title": {
		...
		"privacy-joinPlus": {
			...
			"zh": "<a href='/membership/' target='_blank'>加入Plus+會員</a>以更改私隱設定"
		},
		"sourceNotVisible": {
		...
		"hideSource-joinPlus": {
			...
			"zh": "<a href='/membership/' target='_blank'>加入Plus+會員</a>以隱藏原始碼"
		},
		"privateURL": {
			"description": "info > edit panel",
			"en": "Private URL",
		...
		"privateURL-joinPlus": {
			...
			"zh": "<a href='/membership/' target='_blank'>加入Plus+會員</a>以透過私人連結分享速寫"
		},
		"deleteSketch": {
			"description": "info > edit panel",
			"en": "Delete Sketch?",
	...
	"user": {
		...
		"restricted-warning": {
			...
			"zh": "這是個受限的學生帳戶，你能正常使用OpenProcessing，但你的速寫只會被你的同學和老師看到"
		},
		"bio": {
			"description": "Edit Profile label",
			"en": "bio",
		...
		"backgroundSketch-description": {
			...
			"zh": "請選擇一幅不涉及額外檔案或用家互動的全螢幕速寫以達到最佳效果"
		},
		...
		"crayons": {
			...
			"tr": "{n} Crayon",
			"zh": "0 Crayons | 1 Crayon | {n} Crayons"
		},
		"sketches": {
			"description": "Tab",
